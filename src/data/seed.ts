...
export const defaultPositions: CallingPosition[] = [
  ...
  pos("yw-specialist", "young-women", "Specialist", 5, false, 4),
  pos("yw-specialist-activities", "young-women", "Specialist - Activities", 6, false),
  pos("yw-camp-director", "young-women", "Specialist - Camp Director", 7, false),
  pos("yw-asst-camp-director", "young-women", "Specialist - Assistant Camp Director", 8, false),
  pos("yw-stake-youth", "young-women", "Stake Youth Committee", 9, false),
  pos("yw-specialist-sports", "young-women", "Specialist - Sports", 10, false),
  pos("yw-specialist-sports-asst", "young-women", "Specialist - Sports Assistant", 11, false),
